...
const INITIAL_STATE = { id: 0, dayOfWeek: "", endHour: "", startHour: "", department: 0, course: 0 };
...
const Allocations = () => {
    ...
    const actions = [
        {
            name: "Edit",
            action: ({ id, dayOfWeek, endHour, startHour, department: { id: departmentId}, course: { id: courseId} }) => {
                setAllocation({ id, dayOfWeek, endHour, startHour, department: { id: departmentId}, course: { id: courseId} });
                setVisible(true);
            },
        },
        {
